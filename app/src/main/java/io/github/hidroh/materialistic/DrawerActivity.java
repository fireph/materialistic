...
public abstract class DrawerActivity extends InjectableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout.setSystemUiVisibility(SYSTEM_UI_FLAG_LAYOUT_STABLE | SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
        getWindow().setStatusBarColor(ResourcesCompat.getColor(getResources(), R.color.status_bar_background, null));
        getWindow().setNavigationBarColor(Color.TRANSPARENT);
        mDrawerContent.setOnApplyWindowInsetsListener((view, windowInsets) -> {
            mDrawerContent.setPadding(0, 0, 0, windowInsets.getSystemWindowInsetRight());
            return windowInsets;
        });
    }
